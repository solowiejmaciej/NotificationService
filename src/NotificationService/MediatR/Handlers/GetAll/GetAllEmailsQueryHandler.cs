...
public class GetAllEmailsQueryHandler : IRequestHandler<GetAllEmailsQuery, PageResult<EmailNotificationDto>>
{
    ...
    public async Task<PageResult<EmailNotificationDto>> Handle(GetAllEmailsQuery request,
        CancellationToken cancellationToken)
    {
        ...
        var result =
            new PageResult<EmailNotificationDto>(emailsDtos, totalItemsCount, request.PageSize, request.PageNumber);
